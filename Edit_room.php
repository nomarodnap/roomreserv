...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE listroom SET r_status=%s WHERE r_name=%s",
                       GetSQLValueString($_POST['cboStatus'], "text"),
  ...
  $updateGoTo = "list_room_admin.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_POST['txtRname'])) {
  $colname_Rs_room_detail = $_POST['txtRname'];
}
mysql_select_db($database_ReservBookRooms, $ReservBookRooms);
...
$totalRows_Rs_room_detail = mysql_num_rows($Rs_room_detail);$colname_Rs_room_detail = "-1";
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  <div align="center">
    <table width="249" border="1">
      <tr>
        <td colspan="3"><div align="center"><strong>แก้ไขข้อมูลห้อง</strong></div></td>
      </tr>
      <tr>
        <td width="86"><div align="right">ชื่อห้อง</div></td>
        <td width="1">&nbsp;</td>
        <td width="144"><label for="txtRname"></label>
          <div align="left">
        ...
        <td><label for="cboStatus"></label>
          <div align="left">
            <select name="cboStatus" id="cboStatus" title="<?php echo $row_Rs_room_detail['r_status']; ?>">
              ...
              <option value='$row_Rs_room_detail['r_status']' selected='selected'><?php echo $row_Rs_room_detail['r_status']; ?></option>
              ";
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td><div align="left">
          <input type="submit" name="btnEdit" id="btnEdit" value="แก้ไข" />
        </div></td>
      </tr>
    </table>
  </div>

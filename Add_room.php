...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO listroom (r_name, r_status) VALUES (%s, %s)",
  ...
  $insertGoTo = "list_room_admin.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['r_name'])) {
  $colname_Rs_room_detail = $_GET['r_name'];
}
mysql_select_db($database_ReservBookRooms, $ReservBookRooms);
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  <div align="center">
    <table width="247" border="1">
      <tr>
        <td colspan="3"><div align="center"><strong>เพิ่มข้อมูลห้อง</strong></div></td>
      </tr>
      <tr>
        <td width="79"><div align="right">ชื่อห้อง</div></td>
        <td width="2">&nbsp;</td>
        ...
        <td><label for="cboStatus"></label>
          <div align="left">
            <select name="cboStatus" id="cboStatus" title="<?php echo $row_Rs_room_detail['r_status']; ?>">
              <option value="พร้อมใช้" selected="selected">พร้อมใช้</option>

...
if (isset($_SESSION['user_login'])) { // ถ้าเข้าระบบอยู่
    ...
    $showlogin = "กรุณาลงชื่อเข้าใช้งานก่อน";
}
?>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center" style="color:red;"><?php echo $showlogin; ?></p>
                  </div>
                  ...
                  <form class=" row g-3 needs-validation" novalidate action="check_login.php" method="post">
                    ...
                    <div class="col-6">
                      <p class="small mb-0"><a href="singup.php">สมัครใช้งาน</a></p>
                    </div>
                    <div class="col-6">
                      <p class="small mb-0" style="text-align: end;"><a href="singup.php">ลืมรหัสผ่าน</a></p>
                    </div>
                  </form>

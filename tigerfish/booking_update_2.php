...
$id = $_GET['ref'];
$strSQL = "SELECT * FROM bookingRoom_2 LEFT JOIN user ON bookingRoom_2.U_id=user.U_id WHERE id = '$id'";
$strSQL2 = "SELECT * FROM bookingRoom_2 LEFT JOIN user ON bookingRoom_2.admin_update=user.U_id WHERE id = '$id'";
...
if ($objResult['B_status'] != 'Suspend' && $user['status'] != 'admin') {
    $disabled = 'disabled';
    $hidden = 'hidden';
}
    ...
    <section class="section dashboard">
        <div class="row">
            <div class="col-sm-9 mb-3 mb-sm-0">
                <div class="card ">
                    <div class="card-body">
                        <form action="booking_action_update_2.php" id="form_update" method="post" enctype="multipart/form-data">
                            <div class="col-md-9">
                                <div class="row mt-3">
                                    <!-- แถวที่ 1 -->
                                    <div class="row-md-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="title" name="title" class="form-control" <?php echo $disabled; ?> value="<?php echo $objResult['title']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mt-3">
                                        ...
                                        <div class="input-group col-sm-2">
                                            <input type="number" id="persion" name="persion" class="form-control" value="<?php echo $objResult['persion']; ?>" <?php echo $disabled; ?>><span class="input-group-text" id="basic-addon2">คน</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        ...
                                        if ($user['status'] == 'admin') {
                                            echo '<label for="ststus" class="form-label">สถานะการจอง</label>
                                            <select class="form-select" aria-label="Default select example" d="B_status" name="B_status">
                                                <option value="Suspend">รออนุมัติ</option>
                                                <option value="accept">อนุมัติการจอง</option>
                                            ...
                                            if ($objResult['B_status'] != 'Suspend') {
                                                ...
                                                echo '<select class="form-select form-control" aria-label="Default select example" d="B_status" name="B_status">
                                                <option selected value="Suspend">รออนุมัติ</option>
                                                <option value="reject">ยกเลิกการจอง</option>
                                            </select>';
                                        } ?>
                                    ...
                                    <div class="col-md-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" name="remark" value="<?php echo $objResult['remark']; ?> "require>
                                    </div>
                                    <!-- ปุ่มบันทึก -->
                                    <div class="col-md-12 mt-3">
                                        <button type="submit" class="btn btn-primary btn-sm" <?php echo $hidden; ?>>บันทึกการแก้ไข</button>
                                        <a href="booking_list_2.php"><button type="button" class="btn btn-outline-primary btn-sm">กลับ</button></a>
                                    </div>
                                </div>
                            </div>
                        </form>

...
<body>
    ...
    $sql = "SELECT * FROM bookingRoom INNER JOIN user ON bookingRoom.U_id=user.U_id WHERE id ='" . $_GET['id'] . "'  ";
    $result = $mysqli->query($sql);
    $rs = $result->fetch_object();

    $sql2 = "SELECT * FROM bookingRoom LEFT JOIN user ON bookingRoom.admin_update=user.U_id WHERE id ='" . $_GET['id'] . "'  ";
            ...
            <div class="col-lg-8">
                <div class="panel panel-default">
                    <div class="panel-heading" style="font-weight: bold;">
                        รายละเอียดการขอใช้งานห้องประชุมเสือตอ
                    </div>

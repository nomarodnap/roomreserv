<?php
session_start();
$pagename = 'รายงานการจองห้องฝึกอบรมคอมพิวเตอร์';
include_once('./function.php');
$objCon = connectDB();
$strSQL = "SELECT * FROM bookingRoom_2 INNER JOIN user ON bookingRoom_2.U_id=user.U_id ORDER BY id DESC";
$objQuery = mysqli_query($objCon, $strSQL);
$total_record = mysqli_num_rows($objQuery);
$user = $_SESSION['user_login'];
if ($user['status'] != 'admin_2') {
    ...
    <main id="" class="">
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <div class="text-center fw-bold">การลงทะเบียนเข้าใช้งานห้องอบรม ศทส.</div>

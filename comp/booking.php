...
$pagename = 'จองห้องฝึกอบรมคอมพิวเตอร์';
                    ...
                    <div class="card-body">
                        <form novalidate action="action_booking.php" method="post" enctype="multipart/form-data" class="needs-validation">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-select" aria-label="Default select example" name="persion" required placeholder="รองรับได้ไม่เกิน 22 คน">
                                        <?php for ($x = 1; $x <= 22; $x++) {
                                ...
                                <div class="col-sm-4">
                                    <label for="inputText" class="col-form-label" style="color:red;">รองรับได้ไม่เกิน 22 คน </br> ( PC 20 เครื่อง Notebooks 2 เครื่อง )  <i class="ri ri-admin-fill"></i> </label>
                                </div>
                            </div>

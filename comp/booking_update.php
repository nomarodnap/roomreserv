...
if ($objResult['B_status'] != 'Suspend' && $user['status'] != 'admin_2') {
    $disabled = 'disabled';
    $hidden = 'hidden';
}
...
// ตรวจสอบสิทธิ์ผู้ใช้
$canEdit = ($user['status'] == 'admin_2' || $user['U_id'] == $objResult['U_id']);
$canApprove = ($user['status'] == 'admin_2');
                    ...
                    <form action="booking_action_update.php" id="form_update" method="post" enctype="multipart/form-data">
                        <div class="col-md-9">
                            <div class="row mt-3">
                                <!-- แถวที่ 1 -->
                                <div class="row-md-3">
                                    <label for="title" class="form-label">หัวข้อประชุม</label>
...
<div class="col-md-4 mt-3">
    <label for="persion" class="form-label">จำนวนคน</label>

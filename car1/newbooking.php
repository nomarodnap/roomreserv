...
$id = $_GET['ref'];
$link = "https://roomreserv.fisheries.go.th/newweb/comp/booking_update.php?ref=$id";
                ...
                <div class="card ">
                    <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="row-md-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="title" name="title" class="form-control" value="<?php echo $objResult['title']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-5 mt-3">
                                        <label for="start" class="form-label">วันเวลาเริ่มต้น</label>
                                        <input type="datetime-local" id="lname" name="start" class="form-control" value="<?php echo $objResult['start']; ?>" disabled>
                                    </div>
                                    <!-- แถวที่ 2 -->
                                    <div class="col-md-5 mt-3">
                                        <label for="end" class="form-label">วันเวลาสิ้นสุด</label>
                                        <input type="datetime-local" id="end" name="end" class="form-control " value="<?php echo $objResult['end']; ?>" disabled>
                                    </div>
                                    <div class="col-md-3 mt-3">
                                        <label for="persion" class="form-label">จำนวนผู้ใช้งาน</label>
                                        <div class="input-group col-sm-2">
                                            <input type="number" id="persion" name="persion" class="form-control" value="<?php echo $objResult['persion']; ?>" disabled><span class="input-group-text" id="basic-addon2">คน</span>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12 mt-3">
                            <a href='./login.php'><button type="" class="btn btn-primary btn-sm">ลงชื่อเข้าใช้เพื่อดำเนินการ</button></a>
                        </div>
                    </div>

...
<title>ลบข้อมูลผู้ใช้งานระบบ</title>
</head>

<body>
<form id="form1" name="frmAddUser" method="POST">
  <div align="center">
    <table width="309" border="1">
      <tr>
        <td height="30" colspan="4"><div align="center"><strong>ลบข้อมูลผู้ใช้งานระบบ</strong></div></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>PASSWORD</td>
        <td>&nbsp;</td>
        <td colspan="2"><input name="txtpassword" type="text" id="txtpassword" value="<?php echo $row_Rs_add_user['PASSWORD']; ?>" readonly="readonly" /></td>
      </tr>
      <tr>
        <td>LEVEL</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td width="106"><input type="submit" name="bttAdd" id="bttAdd" value="ลบผู้ใช้" /></td>
